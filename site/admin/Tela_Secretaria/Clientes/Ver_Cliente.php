...
<body>
    <nav>
        <div class="nav-bar">
            ...
            <span class="logo navLogo"><a href="#">pacientes</a></span>
...
<div class="funcionario-profile py-4">
    <div class="container d-flex justify-content-center">
        <div class="row">
            <div class="col-lg-12"> <!-- Mudando para 12 para ocupar toda a largura -->
                <div class="card shadow-sm">
                    ...
                    <div class="card-body pt-0">
                        <table class="table table-bordered" style="font-size: 1.2rem; width: 800px; border-collapse: collapse;">
           
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Paciente ID</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $id; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Nome</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $nome; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Sexo</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $sexo; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Data de Nascimento</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $data_nascimento; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">CPF</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $cpf; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Estado</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $estado; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Cidade</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $cidade; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Bairro</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $bairro; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Rua</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $rua; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Número da Residência</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $numero_residencia; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">CEP</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $cep; ?></td>
                            </tr>
                            <tr>
                                <th width="25%" style="text-align: left; padding-left: 20px;">Telefone</th>
                                <td width="2%" style="text-align: center;">:</td>
                                <td style="padding-left: 20px;"><?php echo $telefone; ?></td>
                            </tr>
                            <tr>
