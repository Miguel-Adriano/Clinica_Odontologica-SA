...
<nav>
        <div class="nav-bar">
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                <li><a href="/Clinica_Odontologica/admin/site/Tela_Secretaria/Ver_Agendamentos.php">Home</a></li>
                    <li></li>
                    <li></li>
                    <li></li>
    ...
    <br><br><br><br>
    <div class="container">
        <h1 class="display-5 mb-4">Deletar Pacientes</h1>
