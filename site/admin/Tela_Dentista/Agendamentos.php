...
$sql_hoje = "SELECT 
            ...
            WHERE agendamentos.data_agendamento = CURDATE()
              AND LOWER(TRIM(agendamentos.status)) != 'concluída'
...
<body>
    <nav>
        <div class="nav-bar">
            ...
            <span class="logo navLogo"><a href="#">Dentista - Agendamentos</a></span>
                ...
                <tbody>
                    <?php foreach ($agendamentos_hoje as $agendamento): ?>
                        <tr>
                            ...
                            <td>
                                <form method="GET" action="detalhes_consulta.php">
                                    <input type="hidden" name="id_agendamento" value="<?php echo $agendamento['id']; ?>">
                                    <input type="hidden" name="id_paciente" value="<?php echo $agendamento['id_paciente']; ?>">
