...
<body>
    <nav>
        <div class="nav-bar">
            ...
            <span class="logo navLogo"><a href="#">Clientes</a></span>
...
<br>
    ...
    <a href="Cadastro_Cliente.php" class="card adicionar">
...
<a href="Editar_Cliente.php" class="card editar">
     <div class="overlay"></div>
  <div class="circle">
...
<a href="Pesquisar_Cliente.php" class="card pesquisar">
     <div class="overlay"></div>
  <div class="circle">
...
<a href="Deletar_Cliente.php" class="card deletar">
     <div class="overlay"></div>
  <div class="circle">
