...
<div class="horarios-container">
    ...
    <form method="POST" action="confirmar_agendamento.php">
        ...
        <!-- O botão só será exibido após o carregamento dos horários -->
        <button type="submit" class="confirmar2">Confirmar Agendamento</button>
    </form>
</div>
...
document.querySelector("form").addEventListener("submit", function(event) {
    ...
    var dataEscolhida = document.querySelector("input[name='data']").value;

    // Verifica se a data foi escolhida
    if (dataEscolhida) {
        // Mostra o botão de confirmar agendamento
        document.querySelector(".confirmar2").style.display = "block";
        
        // Aqui você também pode fazer a lógica para verificar os horários disponíveis
        // (essa parte depende de como o PHP está retornando os dados para os horários).
    }
});
