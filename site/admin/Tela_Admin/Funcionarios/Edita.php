...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE funcionarios SET " . implode(", ", $set_clause) . " WHERE id = ?";
    $params[] = $id;
    ...
    if ($stmt) {
        ...
        // Executar a consulta
        if ($stmt->execute()) {
            echo "<script>alert('Dados atualizados com sucesso!'); window.location.href = 'Pesquisar_Funcionario.php';</script>";
        } else {
