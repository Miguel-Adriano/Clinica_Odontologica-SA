...
$colunas = [
    ...
    4 => 'telefone',
    5 => 'cargo',
    6 => 'deletar'  // Coluna extra para o botão de deletar
];
...
while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
    ...
    // Adiciona um botão com mensagem de confirmação para deletar
    $registro[] = '<a href="Deleta.php?id=' . $id . '" class="btn btn-primary deletar" 
